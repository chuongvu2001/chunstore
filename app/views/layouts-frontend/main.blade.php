...
@include('layouts-frontend.overlay')
...
<section class="slider_section">
    <div class="slider_area owl-carousel">
        <div class="single_slider d-flex align-items-center" data-bgimg="{{THEME_ASSET_URL}}assets/img/slider/slider1.jpg">
            <div class="container">
                <div class="row">
                    <div class="col-12">
        ...
        <div class="single_slider d-flex align-items-center" data-bgimg="{{THEME_ASSET_URL}}assets/img/slider/slider2.jpg">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <div class="slider_content">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="single_shipping">
                    <div class="shipping_icone">
                        <img src="{{THEME_ASSET_URL}}assets/img/about/shipping1.png" alt="">
                    </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="single_shipping">
                    <div class="shipping_icone">
                        <img src="{{THEME_ASSET_URL}}assets/img/about/shipping2.png" alt="">
                    </div>
                    <div class="shipping_content">
                        <h3>Free Returns</h3>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="single_shipping">
                    <div class="shipping_icone">
                        <img src="{{THEME_ASSET_URL}}assets/img/about/shipping3.png" alt="">
                    </div>
                    <div class="shipping_content">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="single_shipping">
                    <div class="shipping_icone">
                        <img src="{{THEME_ASSET_URL}}assets/img/about/shipping4.png" alt="">
                    </div>
                    <div class="shipping_content">
                        <h3>Gift Service</h3>
                ...
                <div class="col-lg-3">
                    <div class="product_items">
                        <article class="single_product">
                            <figure>
                                <div class="product_thumb">
                                    <a class="primary_img" href="../../../index.php"><img src="{{THEME_ASSET_URL}}assets/img/product/product1.jpg" alt=""></a>
                                    <a class="secondary_img" href="../../../index.php"><img src="{{THEME_ASSET_URL}}assets/img/product/product2.jpg" alt=""></a>
                        ...
                        <article class="single_product">
                            <figure>
                                <div class="product_thumb">
                                    <a class="primary_img" href="../../../index.php"><img src="{{THEME_ASSET_URL}}assets/img/product/product3.jpg" alt=""></a>
                                    <a class="secondary_img" href="../../../index.php"><img src="{{THEME_ASSET_URL}}assets/img/product/product4.jpg" alt=""></a>
                ...
                <div class="col-lg-3">
                    <div class="product_items">
                        <article class="single_product">
                            <figure>
                                <div class="product_thumb">
                                    <a class="primary_img" href="../../../index.php"><img src="{{THEME_ASSET_URL}}assets/img/product/product5.jpg" alt=""></a>
                                    <a class="secondary_img" href="../../../index.php"><img src="{{THEME_ASSET_URL}}assets/img/product/product6.jpg" alt=""></a>
                                    <div class="label_product">
                                        <span class="label_sale">-20%</span>
                                    </div>
                                    <div class="action_links">
                        ...
                        <article class="single_product">
                            <figure>
                                <div class="product_thumb">
                                    <a class="primary_img" href="../../../index.php"><img src="{{THEME_ASSET_URL}}assets/img/product/product7.jpg" alt=""></a>
                                    <a class="secondary_img" href="../../../index.php"><img src="{{THEME_ASSET_URL}}assets/img/product/product8.jpg" alt=""></a>
                                    <div class="label_product">
                                        <span class="label_sale">-20%</span>
                                    </div>
                                    <div class="action_links">
                ...
                <div class="col-lg-3">
                    <div class="product_items">
                        <article class="single_product">
                            <figure>
                                <div class="product_thumb">
                                    <a class="primary_img" href="../../../index.php"><img src="{{THEME_ASSET_URL}}assets/img/product/product9.jpg" alt=""></a>
                                    <a class="secondary_img" href="../../../index.php"><img src="{{THEME_ASSET_URL}}assets/img/product/product10.jpg" alt=""></a>
                                    <div class="action_links">
                                        <ul>
                                            <li class="add_to_cart"><a href="../../../index.php" title="Add tob cart"><i class="icon-bag icons"></i></a></li>
                                            <li class="wishlist"><a href="../../../index.php" title="Add to Wishlist"><i class="icon-heart icons"></i></a></li>
                        ...
                        <article class="single_product">
                            <figure>
                                <div class="product_thumb">
                                    <a class="primary_img" href="../../../index.php"><img src="{{THEME_ASSET_URL}}assets/img/product/product11.jpg" alt=""></a>
                                    <a class="secondary_img" href="../../../index.php"><img src="{{THEME_ASSET_URL}}assets/img/product/product12.jpg" alt=""></a>
                                    <div class="action_links">
                                        <ul>
                                            <li class="add_to_cart"><a href="../../../index.php" title="Add tob cart"><i class="icon-bag icons"></i></a></li>
                                            <li class="wishlist"><a href="../../../index.php" title="Add to Wishlist"><i class="icon-heart icons"></i></a></li>
                ...
                <div class="col-lg-3">
                    <div class="product_items">
                        <article class="single_product">
                            <figure>
                                <div class="product_thumb">
                                    <a class="primary_img" href="../../../index.php"><img src="{{THEME_ASSET_URL}}assets/img/product/product13.jpg" alt=""></a>
                                    <a class="secondary_img" href="../../../index.php"><img src="{{THEME_ASSET_URL}}assets/img/product/product14.jpg" alt=""></a>
                                    <div class="label_product">
                                        <span class="label_sale">-20%</span>
                                    </div>
                                    <div class="action_links">
                        ...
                        <article class="single_product">
                            <figure>
                                <div class="product_thumb">
                                    <a class="primary_img" href="../../../index.php"><img src="{{THEME_ASSET_URL}}assets/img/product/product2.jpg" alt=""></a>
                                    <a class="secondary_img" href="../../../index.php"><img src="{{THEME_ASSET_URL}}assets/img/product/product1.jpg" alt=""></a>
                                    <div class="action_links">
                                        <ul>
                                            <li class="add_to_cart"><a href="../../../index.php" title="Add tob cart"><i class="icon-bag icons"></i></a></li>
                                            <li class="wishlist"><a href="../../../index.php" title="Add to Wishlist"><i class="icon-heart icons"></i></a></li>
                ...
                <div class="col-lg-3">
                    <div class="product_items">
                        <article class="single_product">
                            <figure>
                                <div class="product_thumb">
                                    <a class="primary_img" href="../../../index.php"><img src="{{THEME_ASSET_URL}}assets/img/product/product4.jpg" alt=""></a>
                                    <a class="secondary_img" href="../../../index.php"><img src="{{THEME_ASSET_URL}}assets/img/product/product3.jpg" alt=""></a>
                                    <div class="action_links">
                                        <ul>
                                            <li class="add_to_cart"><a href="../../../index.php" title="Add tob cart"><i class="icon-bag icons"></i></a></li>
                                            <li class="wishlist"><a href="../../../index.php" title="Add to Wishlist"><i class="icon-heart icons"></i></a></li>
                        ...
                        <article class="single_product">
                            <figure>
                                <div class="product_thumb">
                                    <a class="primary_img" href="../../../index.php"><img src="{{THEME_ASSET_URL}}assets/img/product/product6.jpg" alt=""></a>
                                    <a class="secondary_img" href="../../../index.php"><img src="{{THEME_ASSET_URL}}assets/img/product/product5.jpg" alt=""></a>
                                    <div class="label_product">
                                        <span class="label_sale">-20%</span>
                                    </div>
                                    <div class="action_links">
        ...
        <div class="row">
            <div class="col-12">
                <div class="categories_banner">
                    <img src="{{THEME_ASSET_URL}}assets/img/bg/banner1.jpg" alt="">
            ...
            <div class="col-12">
                <div class="brand_container owl-carousel ">
                    <div class="single_brand">
                        <a href="#"><img src="{{THEME_ASSET_URL}}assets/img/brand/brand1.jpg" alt=""></a>
                    </div>
                    <div class="single_brand">
                        <a href="#"><img src="{{THEME_ASSET_URL}}assets/img/brand/brand2.jpg" alt=""></a>
                    </div>
                    <div class="single_brand">
                        <a href="#"><img src="{{THEME_ASSET_URL}}assets/img/brand/brand3.jpg" alt=""></a>
                    </div>
                    <div class="single_brand">
                        <a href="#"><img src="{{THEME_ASSET_URL}}assets/img/brand/brand4.jpg" alt=""></a>
                    </div>
                    <div class="single_brand">
                        <a href="#"><img src="{{THEME_ASSET_URL}}assets/img/brand/brand5.jpg" alt=""></a>
                    </div>
                    <div class="single_brand">
                        <a href="#"><img src="{{THEME_ASSET_URL}}assets/img/brand/brand6.jpg" alt=""></a>
                    </div>
                    <div class="single_brand">
                        <a href="#"><img src="{{THEME_ASSET_URL}}assets/img/brand/brand7.jpg" alt=""></a>
                    </div>
                    <div class="single_brand">
                        <a href="#"><img src="{{THEME_ASSET_URL}}assets/img/brand/brand1.jpg" alt=""></a>
                    </div>
            ...
            <div class="blog_carousel blog_column3 owl-carousel">
                    ...
                    <article class="single_blog">
                        <figure>
                            <div class="blog_thumb">
                                <a href="../../../index.php"><img src="{{THEME_ASSET_URL}}assets/img/blog/blog1.jpg" alt=""></a>
                            </div>
                ...
                <div class="col-lg-3">
                    <article class="single_blog">
                        <figure>
                            <div class="blog_thumb">
                                <a href="../../../index.php"><img src="{{THEME_ASSET_URL}}assets/img/blog/blog2.jpg" alt=""></a>
                            </div>
                            <figcaption class="blog_content">
                ...
                <div class="col-lg-3">
                    <article class="single_blog">
                        <figure>
                            <div class="blog_thumb">
                                <a href="../../../index.php"><img src="{{THEME_ASSET_URL}}assets/img/blog/blog3.jpg" alt=""></a>
                            </div>
                            <figcaption class="blog_content">
                ...
                <div class="col-lg-3">
                    <article class="single_blog">
                        <figure>
                            <div class="blog_thumb">
                                <a href="../../../index.php"><img src="{{THEME_ASSET_URL}}assets/img/blog/blog4.jpg" alt=""></a>
                            </div>
                            <figcaption class="blog_content">
                ...
                <div class="col-12">
                    <div class="testimonial_thumb_wrapper testimonial_thumb_column3">
                        <div class="testimonial_thumb">
                            <img src="{{THEME_ASSET_URL}}assets/img/about/testimonial1.png" alt="">
                        </div>
                        <div class="testimonial_thumb">
                            <img src="{{THEME_ASSET_URL}}assets/img/about/testimonial2.png" alt="">
                        </div>
                        <div class="testimonial_thumb">
                            <img src="{{THEME_ASSET_URL}}assets/img/about/testimonial3.png" alt="">
                        </div>
                        <div class="testimonial_thumb">
                            <img src="{{THEME_ASSET_URL}}assets/img/about/testimonial1.png" alt="">
                        </div>
            ...
            <div class="col-lg-6 col-md-6">
                <div class="single_banner">
                    <div class="banner_thumb">
                        <a href="#"><img src="{{THEME_ASSET_URL}}assets/img/bg/banner2.jpg" alt=""></a>
                    </div>
                </div>
            </div>
            <div class="col-lg-6 col-md-6">
                <div class="single_banner">
                    <div class="banner_thumb">
                        <a href="#"><img src="{{THEME_ASSET_URL}}assets/img/bg/banner3.jpg" alt=""></a>
                    </div>
                </div>
            </div>
        </div>
